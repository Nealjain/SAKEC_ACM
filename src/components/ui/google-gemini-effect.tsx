...
const rotatingTexts = [
  ...
  "Building tomorrow's tech leaders with hands-on experience",
  "Join us in advancing computing as a science and profession",
  "Creating a community of innovators and problem solvers",
...
export const GoogleGeminiEffect = ({
  ...
  return (
    <div className={cn("sticky top-0 h-screen w-full flex flex-col items-center justify-center overflow-hidden bg-[#FAF9F6]", className)}>
      <div className="relative z-50 flex flex-col items-center justify-center -mt-16 md:-mt-40">
        ...
        <div className="text-lg sm:text-xl md:text-2xl font-normal text-center text-gray-700 mt-4 max-w-2xl mx-auto min-h-[100px] sm:min-h-[80px] md:min-h-[80px] flex items-center justify-center px-4">
          <TypewriterEffect
            texts={rotatingTexts}
            className="text-lg sm:text-xl md:text-2xl font-normal text-gray-700"
            typingSpeed={80}
            deletingSpeed={40}
        ...
        <div className="mt-8 md:mt-12 flex justify-center w-full">
          <Link
            to="/join"
            className="group relative font-bold bg-black text-white rounded-full px-8 py-4 sm:px-10 sm:py-5 md:px-10 md:py-5 text-base sm:text-lg md:text-xl w-fit transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-black/50 block overflow-hidden border-2 border-white pointer-events-auto"
          >
      ...
      <svg
        ...
        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-auto pointer-events-none opacity-50 md:opacity-100"
      >
        <motion.path
