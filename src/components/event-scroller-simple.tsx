    ...
    <section ref={containerRef} className="relative h-screen overflow-hidden">
      <div className="h-screen w-full relative">
        ...
        {events.map((event, index) => (
          <div
            key={event.id}
            className={`absolute inset-0 flex flex-col lg:flex-row transition-all duration-1000 ease-out ${index === currentIndex
          ...
          >
            ...
            <div className="flex-1 flex items-center justify-center p-8 lg:p-16 relative z-20">
              <div className={`w-full max-w-2xl transition-all duration-1000 ease-out ${index === currentIndex
            ...
            <div className="hidden lg:flex flex-1 relative items-center justify-center z-20">
              <div className={`text-center transition-all duration-1000 ease-out ${index === currentIndex
