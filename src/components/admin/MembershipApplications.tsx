        ...
        <div className="space-y-4 sm:space-y-6">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-gray-500 text-sm sm:text-base">Manage student chapter membership requests</p>
                </div>
                <div className="bg-gray-100 text-gray-800 px-3 sm:px-4 py-2 rounded-full font-medium text-sm">
            ...
            <div className="relative">
                ...
                <input
                    ...
                    className="w-full pl-9 sm:pl-10 pr-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-500 text-sm sm:text-base"
                />
            </div>
                                    ...
                                    <div key={app.id} className="p-4 space-y-3">
                                        <div className="flex items-start justify-between">
                                            <div className="flex-1 min-w-0">
                                                <h3 className="font-medium text-gray-900 truncate">{app.full_name}</h3>
                                                <p className="text-sm text-gray-500 truncate">{app.email}</p>
                                                <p className="text-sm text-gray-500">{app.contact_number}</p>
                                            </div>
                                        ...
                                        <div className="grid grid-cols-2 gap-3 text-sm">
                                            <div>
                                                ...
                                                <span className="ml-1 text-gray-900">{app.prn}</span>
                                            </div>
                                            <div>
                                                <span className="text-gray-500">Division:</span>
                                                <span className="ml-1 text-gray-900">{app.division}</span>
                                            </div>
                                            <div>
                                                <span className="text-gray-500">Roll:</span>
                                                <span className="ml-1 text-gray-900">{app.roll_number}</span>
                                            </div>
                                            <div>
                                                <span className="text-gray-500">Date:</span>
                                                <span className="ml-1 text-gray-900">{new Date(app.created_at).toLocaleDateString()}</span>
                                            </div>
                                        </div>
                                        ...
                                        <div className="flex items-center justify-between pt-2">
                                            <a
                                                ...
                                                className="inline-flex items-center gap-1 text-gray-700 hover:text-gray-900 text-sm font-medium bg-gray-100 hover:bg-gray-200 px-3 py-1.5 rounded-md transition-colors"
                                            >
                                                View Payment
                        ...
                        <div className="hidden sm:block overflow-x-auto">
                            <table className="w-full text-left">
                                <thead className="bg-gray-50 border-b border-gray-100">
                                    <tr>
                                        <th className="px-4 lg:px-6 py-3 lg:py-4 text-xs font-semibold text-gray-500 uppercase">Date</th>
                                        <th className="px-4 lg:px-6 py-3 lg:py-4 text-xs font-semibold text-gray-500 uppercase">Student Details</th>
                                        <th className="px-4 lg:px-6 py-3 lg:py-4 text-xs font-semibold text-gray-500 uppercase">Academic</th>
                                        <th className="px-4 lg:px-6 py-3 lg:py-4 text-xs font-semibold text-gray-500 uppercase">Payment</th>
                                        <th className="px-4 lg:px-6 py-3 lg:py-4 text-xs font-semibold text-gray-500 uppercase">Status</th>
                                        <th className="px-4 lg:px-6 py-3 lg:py-4 text-xs font-semibold text-gray-500 uppercase">Actions</th>
                                    </tr>
                                </thead>
